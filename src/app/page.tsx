    ...
    <div>
      ...
      <section className="w-full bg-white py-8 md:py-12 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-zalando-medium text-black mb-4 md:mb-6 leading-tight">
      ...
      <section className="w-full bg-white pt-4 pb-8 md:py-8 px-4">
        <FeaturesSection />
      </section>

-- Migration: Corrigir constraint valid_reason na tabela plan_rejection_metrics
-- Data: 2025-12-22
-- Problema: A constraint não inclui todos os motivos de rejeição usados no código

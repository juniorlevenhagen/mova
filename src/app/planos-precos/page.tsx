        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-green-500 p-8 text-center text-white">
              ...
              <p className="text-xl opacity-90">{plan.description}</p>
            </div>
            ...
            <div className="p-8 text-center">
              <div className="mb-6">
                ...
                <div className="text-green-600 text-lg font-medium mt-2">
                  {plan.trialText}
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-green-500 text-white py-4 px-8 rounded-lg font-medium hover:from-blue-600 hover:to-green-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-xl mb-4"
              >
                {plan.buttonText}
              </button>
